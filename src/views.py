...
class ElevatorSystemViewSet(viewsets.ModelViewSet):
    """
        This Django view generates an elevator system, starts elevators, and displays the elevators connected to 
        a specific elevator system.
...
class ElevatorViewSet(viewsets.ModelViewSet):
    """
        This Django viewset has actions for displaying, updating, obtaining the destination, 
        obtaining the status of requests, sending requests, and obtaining the proper serializer class.
